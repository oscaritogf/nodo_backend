...
const ToggleComponent = () => {
  ...
  // Define la opción seleccionada según la ruta actual
  const selectedOption = pathname.includes('prestamista') ? 'prestamista' : 'prestatario';

  const toggleOption = (option) => {
    router.push(`/${option}`); // Navega a la nueva ruta
  };
