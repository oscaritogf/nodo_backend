...
import { GetLoanRequestByLender } from '@/services/GetLoanRequestByUser';
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {currentLoans.map((loan) =>
          isOnLoans ? (
            ...
            <Link key={loan.SolicitudID} href={`/inicio/prestatario/gestion/${loan.SolicitudID}`}>
